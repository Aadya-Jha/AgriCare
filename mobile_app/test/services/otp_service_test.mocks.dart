...
// in agri_monitor/test/services/otp_service_test.dart.
...
import 'package:agri_monitor/core/services/storage_service.dart' as _i7;
...
class MockStorageService extends _i1.Mock implements _i7.StorageService {
  ...
  @override
  _i3.Future<bool> setBatch(Map<String, dynamic>? data) => (super.noSuchMethod(
        Invocation.method(
          #setBatch,
          [data],
        ),
  ...
  @override
  _i3.Future<Map<String, dynamic>> getBatch(List<String>? keys) =>
      (super.noSuchMethod(
        Invocation.method(
          #getBatch,
          [keys],
